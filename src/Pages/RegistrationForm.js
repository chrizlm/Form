...
const MyCardComponent = styled('div')({
    ...
    maxWidth: true,
    backgroundImage:
        "url('https://res.cloudinary.com/chrislm/image/upload/v1659689771/Namdah%20Tours/jon-flobrant-_r19nfvS3wY-unsplash_uqvuql.jpg')",
    height:'auto',
    //marginTop:'-70px',
    fontSize:'50px',
        ...
        <MyCardComponent>
            <Card sx={{ maxWidth: true , margin: 10, alignContent: 'center', borderRadius: 0}} elevation={12}>
                <CardMedia
                    component="img"
                    height= "140"
                    image="https://res.cloudinary.com/chrislm/image/upload/v1659690075/Namdah%20Tours/chang-duong-Sj0iMtq_Z4w-unsplash_ukkoll.jpg"
                    alt="happy clients"
                    ...
                    <Grid container spacing={2} rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                        ...
                        <Grid item xs={12} md={6}>
                            <div>
                                <Controller
                                    ...
                                    render={({field}) => (
                                        <TextField {...register('nationality')} label="nationality"/>
                                    )}
                                />
                                {errors?.nationality && errors.nationality.message
                                ? <Alert severity="error">{errors?.nationality && errors.nationality.message}</Alert>
                                : <small></small>}
                        ...
                        <Grid item xs={12} md={6}>
                            <div>
                                ...
                                ? <Alert severity="error">{errors?.password && errors.password.message}</Alert>
                                : <small></small>}

                            </div>
                        </Grid>
                        <Grid item xs={12}>
                            <Button variant="contained" onClick={handleSubmit(handleRegistration, handleError)}>Submit</Button>
